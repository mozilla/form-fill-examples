...
// Reference: https://cs.chromium.org/chromium/src/components/autofill/core/browser/autofill_data_util.cc
...
var NameUtils = {
  ...
  NAME_SUFFIXES: [
    ...
    "m.d", "ma", "md", "ms", "ph.d", "phd", "sr", "v", "vi", "vii", "viii", "x",
  ],

  FAMILY_NAME_PREFIXES: [
    "d'", "de", "del", "der", "di", "la", "le", "mc", "san", "st", "ter", "van",
    "von",
  ],
  ...
  _isCJKName(name) {
    ...
    for (let c of name) {
      ...
      let isCJK = !isMiddleDot && reCJK.test(c);
